...
export default class Map extends Component {
  state = {
    shelters: [
      {
        name: 'Out of the Cold. Overnight Shelters',
        address:
          "All Saints' (Kingsway) Anglican Church, 2850 Bloor St West, Toronto, ON M8X 1B2",
        lat: 0,
        lng: 0,
      },
      {
        name: 'Canadian Red Cross, Toronto Branch',
        address: '557 Dixon Rd Unit 122, Toronto, ON M9W 1A8',
        lat: 0,
        lng: 0,
      },
      {
        name: 'Salvation Army Islington Avenue',
        address: '2671 Islington Ave 3rd Fl, Toronto, ON M9V 2X6',
        lat: 0,
        lng: 0,
      },
    ],
    ...
    return (
      <View style={styles.container}>
        <MapView
          ...
          initialRegion={{
            latitude: shelters.length ? shelters[0].lat : 0,
            longitude: shelters.length ? shelters[0].lng : 0,
            latitudeDelta: 0.09,
